...
- **"Pages kết nối" tụt mạnh** → 1 token chết/mất quyền (JWT ~90 ngày; via FB chết → quyền rụng dần). Thêm token tài khoản còn quyền vào `PANCAKE_TOKENS_EXTRA` (test coverage 12 page bằng conversations API trước khi thêm). Hạn các token hiện tại (6): cũ 28/09 (đã mất hết quyền — giữ vô hại), Hồ Sỹ Aanh 29/10, Thùy Nhung 25/10, CHÍNH 1 28/10, Chu Thuý 22/10, N. Thế 27/10/2026 — GIA HẠN CẢ LOẠT cuối tháng 10.
