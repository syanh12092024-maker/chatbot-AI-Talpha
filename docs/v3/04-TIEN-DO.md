...
| **B-Y6** | Ba chỗ lược đồ chặn sóng 2 (kịch bản tầng trên · lớp 0 đồng · thư viện ảnh) | ✅ **25/08** | migration 012 · `l0-m2-kich-ban` **20 pass** · `l0-m2-so-lieu` **18 pass** · tầng CHỈ-NƯỚC (010 của tôi treo tầng nước vào tầng sản phẩm đang 0 dòng) · bảng `mau_0_dong` + bộ đếm nguyên tử · ⓒ trả lời bằng số đo, chưa dựng bảng |
| **B-Y5** | Cửa ĐỌC không ghi nhật ký cho `ctxHeThong()` | ✅ **25/08** | cổng L0-M2 **30/31** · bộ ca **22 pass / 0 fail** · `nhat_ky` đang 1557 dòng và **100% là `doc`** · cờ chỉ tắt cho ĐỌC, lệnh GHI vẫn để dấu vết |
